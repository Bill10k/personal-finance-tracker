...
function LoginForm({ onForgot, onLoginSuccess }) {
  ...
  onClick={(e) => {
    ...
    if (isLoginMode) {
      // TEMP: Just simulate a successful login
      onLoginSuccess()
    } else {
      // Later: handle signup here
      alert("Signup logic coming soon!")
    }
  }}
  className="w-full p-3 bg-black text-white rounded-full text-lg font-medium hover:opacity-90 transition"
>
